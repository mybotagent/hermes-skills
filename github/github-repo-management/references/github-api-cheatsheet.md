...
| Get README | GET | `/repos/{owner}/{repo}/readme` (raw: add `Accept: application/vnd.github.v3.raw`) |

**PUT requires** `{"message": "...", "content": "<base64>", "sha": "<current_sha>"}`.
Always fetch SHA first (GET), then include in PUT body.
